...
% disp(['LCAEFA is training FNN (Run # = ', num2str(i),' ,MSE = ', num2str(CFbest),')'])
%      end
% %   for tt=1:11
%        Rrate=0;
%                 W=Lbest(1:4*Hno);
...
% % disp(['GA is training FNN (Run # = ', num2str(i),' ,MSE = ', num2str(Best_scoreGA),' Classification rate = ' , num2str(Classification_rate(i)),')']) 
...
% %         legend('\fontsize{15}\bf GSA','\fontsize{15}\bf LPSO','\fontsize{15}\bf LCAEFA',1);
%    axis tight
% % grid on
% box on
