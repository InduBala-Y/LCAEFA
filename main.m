...
%         [PcgCurve,GBEST]=Lpso(SearchAgents_no,Max_iteration,lb,ub,dim,fobj);
%         BestSolutions2(i) = GBEST.O;
%          [gBestScore1,gBest1,GlobalBestCost1]=AEFA(SearchAgents_no,Max_iteration,lb,ub,dim,fobj);
%          BestSolutions3(i) = gBestScore1;
%           [gBestScore,gBest,GlobalBestCost]= CLGSA(SearchAgents_no,Max_iteration,lb,ub,dim,fobj);
...
%         
% [Best_scoreGA,Best_posGA,GA_cg_curve]=GA(SearchAgents_no,Max_iteration,lb,ub,dim,fobj);
%  BestSolutions8(i) = Best_scoreGA ;
...
%  
%   [CFbest,CLbest,CBestChart]= LCAEFA(SearchAgents_no,Max_iteration, min_flag,lb,ub,dim,fobj, Algorithm_num); 
%   BestSolutions11(i) = CFbest;
%   
% %  disp(['GSA is training FNN (Run # = ', num2str(i),' ,MSE = ', num2str(Fbest),')'])  
% %  disp(['LPSO is training FNN (Run # = ', num2str(i),' ,MSE = ', num2str(GBEST.O),')'])  
% %  disp(['AEFA is training FNN (Run # = ', num2str(i),' ,MSE = ', num2str(gBestScore1),')'])  
% %  disp(['CLGSA is training FNN (Run # = ', num2str(i),' ,MSE = ', num2str(gBestScore),')'])
...
% %  disp(['GA is training FNN (Run # = ', num2str(i),' ,MSE = ', num2str(Best_scoreGA),')']) 
...
%  W=GA_cg_curve(1:4*Hno);
%  B=GA_cg_curve(4*Hno+1:dim);
...
% %  display('GSA   LPSO')
%   display('   GSA    LPSO       AEFA    CLGSA     ACO       BBO   DE       GA       SCA       SSA     LCAEFA')
...
% %  disp(['SCA is training FNN (Run # = ', num2str(i),' ,MSE = ', num2str(Best_scoreSCA),')'])
% % disp(['SSA is training FNN (Run # = ', num2str(i),' ,MSE = ', num2str(Best_score),')'])
% disp(['LCAEFA is training FNN (Run # = ', num2str(i),' ,MSE = ', num2str(CFbest),' ,Algorithm = ', num2str(Algorithm_num), ')'])
%  end
%  
%                 W=Lbest(1:45);
%                 B=Lbest(46:55);
...
% % disp(['LPSO is training FNN (Run # = ', num2str(i),' ,MSE = ', num2str(GBEST.O),' Classification rate = ' , num2str(Classification_rate(i)),')'])  
% % disp(['AEFA is training FNN (Run # = ', num2str(i),' ,MSE = ', num2str(gBestScore1),' Classification rate = ' , num2str(Classification_rate(i)),')'])  
% % disp(['CLGSA is training FNN (Run # = ', num2str(i),' ,MSE = ', num2str(gBestScore),' Classification rate =' , num2str(Classification_rate(i)),')'])
...
% % disp(['GA is training FNN (Run # = ', num2str(i),' ,MSE = ', num2str(Best_scoreDA),' Classification rate = ' , num2str(Classification_rate(i)),')']) 
...
% %  disp(['BBO is training FNN (Run # = ', num2str(i),' ,MSE = ', num2str(BestSol.Cost),')'])
% % disp(['DE is training FNN (Run # = ', num2str(i),' ,MSE = ', num2str(BestSolDE.Cost),')']) 
% %   disp(['GA is training FNN (Run # = ', num2str(i),' ,MSE = ', num2str(Best_scoreDA),')']) 
% %  disp(['SCA is training FNN (Run # = ', num2str(i),' ,MSE = ', num2str(Best_scoreSCA),')'])
% % disp(['SSA is training FNN (Run # = ', num2str(i),' ,MSE = ', num2str(Best_score),')'])
% % disp(['LCAEFA is training FNN (Run # = ', num2str(i),' ,MSE = ', num2str(CFbest),' ,Algorithm = ', num2str(Algorithm_num), ')'])
% 
...
% % % % 
% % %  W=GA_cg_curve(1:23*Hno);
% % %  B=GA_cg_curve(23*Hno+1:dim);
%   W=1:23*Hno;
%   B=23*Hno+1:dim;
...
W=GA_cg_curve(1:2*Hnode);
B=GA_cg_curve(2*Hnode+1:3*Hnode+1);
...
%         BestSolutions7(i) = BestSolDE.Cost ;
% %         
% [Best_scoreGA,Best_posGA,GA_cg_curve]=DA(SearchAgents_no,Max_iteration,lb,ub,dim,fobj);
%  BestSolutions8(i) = Best_scoreGA ;
%  [Best_scoreSCA,Best_posSCA,SCA_cg_curve]=SCA(SearchAgents_no,Max_iteration,lb,ub,dim,fobj);
%  BestSolutions9(i) = Best_scoreSCA ;
%  [Best_score,Best_posSSA,SSA_cg_curve]=SSA(SearchAgents_no,Max_iteration,lb,ub,dim,fobj);
...
%          hold on
% % % % %     
%       semilogy(1:Max_iteration,PcgCurve,'DisplayName','LPSO','Color','c','Marker','p','LineStyle','-','LineWidth',2.5,'MarkerSize',5); %Done (Cyan)
% %      disp( ['Time_LPSO =', num2str(toc)]); 
% % % 
%       semilogy(1:Max_iteration,GlobalBestCost1,'DisplayName','AEFA','Color','b','Marker','*','LineStyle','-','LineWidth',3);
% %       disp( ['Time_AEFA =', num2str(toc)]); 
% % % % % % % 
%        semilogy(1:Max_iteration,GlobalBestCost,'DisplayName','CLGSA', 'Color',[0.6350 0.0780 0.1840],'Marker','d','MarkerSize',5,'LineStyle','-','LineWidth',2.5);
% %       disp( ['Time_CLGSA =', num2str(toc)]); 
% % % % % % % % 
...
% % % % % % % 
%      semilogy(1:Max_iteration,DA_cg_curve,'DisplayName','GA','Color',[0.4 0.1 0.5],'Marker','v','MarkerSize',5,'LineStyle','-','LineWidth',2.5); %Done (Triplet 6)
% %   disp( ['Time_GA =', num2str(toc)]); 
% % % % 
...
% % % 
%    semilogy(1:Max_iteration,CBestChart,'DisplayName','LCAEFA', 'Color', 'r','Marker','*','MarkerSize',5,'LineStyle','-','LineWidth',3); %Done (Red)
% %    disp( ['Time_LCAEFA =', num2str(toc)]);
% %    
...
% %         legend('\fontsize{15}\bf GSA','\fontsize{15}\bf LPSO','\fontsize{15}\bf AEFA','\fontsize{15}\bf CLGSA','\fontsize{15}\bf BBO','\fontsize{15}\bf DE','\fontsize{15}\bf ACO','\fontsize{15}\bf GA','\fontsize{15}\bf SCA','\fontsize{15}\bf SSA','\fontsize{15}\bf LCAEFA',1);
% %         legend('\fontsize{15}\bf AEFA','\fontsize{15}\bf LPSO','\fontsize{15}\bf LCAEFA',1);
%    axis tight
% % grid on
% box on
...
% % % % % %  
      boxplot([BestSolutions1',BestSolutions2',BestSolutions3',BestSolutions4',BestSolutions5',BestSolutions6',BestSolutions7',BestSolutions8',BestSolutions9',BestSolutions10',BestSolutions11'],...
       {'GSA','LPSO','AEFA','CLGSA','ACO','BBO','DE','GA','SCA','SSA','LCAEFA'})
